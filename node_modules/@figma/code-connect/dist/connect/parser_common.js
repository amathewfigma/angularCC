...
exports.parseCodeConnect = exports.parseImports = exports.parseVariant = exports.parseLinks = exports.findDescendants = exports.isFigmaConnectCall = exports.isFigmaConnectFile = exports.getReferencedPropsForTemplate = exports.visitPropReferencingNode = exports.makeCreatePropPlaceholder = exports.InternalError = exports.ParserError = exports.getPositionInSourceFile = void 0;
...
function visitPropReferencingNode({ propsParameter, node, createPropPlaceholder, useJsx, }) {
    ...
    if (typescript_1.default.isObjectBindingPattern(propsParameter.name)) {
        const isValidNode = useJsx ? typescript_1.default.isJsxExpression(node) : typescript_1.default.isIdentifier(node);
 ...
 */
function getReferencedPropsForTemplate({ propMappings, referencedProps, exp, sourceFile, }) {
    let templateCode = '';
