...
export declare function makeCreatePropPlaceholder({ propMappings, referencedProps, sourceFile, }: {
    ...
    wrapInJsxExpression?: boolean | undefined;
 ...
 */
export declare function getReferencedPropsForTemplate({ propMappings, referencedProps, exp, sourceFile, }: {
    /** The prop mappings object */
    propMappings: PropMappings | undefined;
 ...
 */
export declare function isFigmaConnectFile(program: ts.Program, file: string, extension: string): boolean;
/**
