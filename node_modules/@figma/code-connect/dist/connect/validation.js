...
exports.validateDocs = exports.parseFigmaNode = void 0;
...
async function fetchNodeInfo(baseApiUrl, fileKey, nodeIdsChunk, accessToken) {
    try {
        const response = await axios_1.default.get(`${baseApiUrl}${fileKey}/nodes?ids=${nodeIdsChunk.join(',')}`, { headers: (0, figma_rest_api_1.getHeaders)(accessToken) });
